...
# =============================================================================
FROM cgr.dev/chainguard/node:latest-dev@sha256:9ab40cf931ad924921617fbb82345e7198a1887090653eee93c348e02fd72b8d AS node-builder
...
ARG TYPES_NODE_VERSION=25.2.1
# renovate: datasource=npm depName=@anthropic-ai/claude-code
ARG CLAUDE_CODE_VERSION=2.1.34
...
# =============================================================================
FROM cgr.dev/chainguard/wolfi-base:latest@sha256:2bdab5abde97a1487c667d3ffcc7265fa9abdeb5b2365bca9a64a5f3afc5a563 AS final
